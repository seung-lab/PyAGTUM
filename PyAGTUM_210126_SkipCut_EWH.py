...
class PreCamTimer(log.valuelogger):
 ...
 #           cam.name=self.CamFrames[icam].text()
    ...
    #            print('{0} {1}'.format(npimg.shape[0],npimg.shape[1]))
            ...
            try:
                with open('C:/Users/jprice/ERROR_test_EWH_32322.txt', 'a') as f:
                    f.write(f'Pre Camera: Error: {e}, Time: {time_now}')
            ...
            try:
                ...
                print("Tried to reset PostCam, but failed.")
...
if __name__ == "__main__":
    ...
    window = mainGUI(os.path.join(application_path,"PyAGTUM_mainwindow_210302_EWH.ui")) #EWH
