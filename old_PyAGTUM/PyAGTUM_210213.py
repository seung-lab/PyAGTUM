...
# 210213 replace leica camera with knife camera
...
class LeicaCam(log.valuelogger):
    def setupCams(self):
    ...
    def updateVis(self):
        try:
            ...
            if ret:
                ...
                pix = QtGui.QPixmap.fromImage(onvertToQtFormat)
                cam.frame.setPixmap(pix)
        except:
            print('Image skipped for Leica Cam')
...
class mainGUI(QtWidgets.QMainWindow):
    ...
    def SetupHardware(self):
        ...
        self.LeicaCam = LeicaCam()  
        self.LeicaCam.setupCams()
        self.LeicaCam.start()
...
if __name__ == "__main__":
    ...
    window = mainGUI(os.path.join(application_path,"PyAGTUM_mainwindow_wLeicaCam_210213.ui"))
